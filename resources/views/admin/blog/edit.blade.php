        ...
        <div class="card-body">
            ...
            <form action="{{ route('blog.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="category" class="form-label card-category">Category <span class="text-danger"
                                    style="font-size: 1rem;">*</span></label>
                            <input value="{{ $blog->category }}" id="name" name="category" type="text"
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <img class="mt-2" src="/img/blog/{{ $blog->image }}" width="300px">
                        </div>
                    </div>
                </div>
