            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        <h4>Our Services</h4>
                        <ul>
                            <li><i class="bx bx-chevron-right"></i> <a href="#">Child protection training and
                                    advocacy</a></li>
                            <li><i class="bx bx-chevron-right"></i> <a href="#">Provision of affordable, quality
                                    water sources</a></li>
                            <li><i class="bx bx-chevron-right"></i> <a href="#">Provision of communication
                                    therapy services</a></li>
                            <li><i class="bx bx-chevron-right"></i> <a href="#">Support to Baptist associations
                                    and churches in growing their capacity
...
<script src="{{ asset('admin-assets/assets/vendor/chart.js/chart.min.js') }}"></script>
